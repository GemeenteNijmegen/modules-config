...
| <code><a href="#@gemeentenijmegen/config.ConfigTable.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gemeentenijmegen/config.ConfigTable.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gemeentenijmegen/config.ConfigTable.with.parameter.mixins"></a>
