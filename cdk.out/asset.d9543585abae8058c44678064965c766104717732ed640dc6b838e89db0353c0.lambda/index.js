...
// src/retrieveconfig/retrieveconfig.lambda.ts
var retrieveconfig_lambda_exports = {};
__export(retrieveconfig_lambda_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(retrieveconfig_lambda_exports);
